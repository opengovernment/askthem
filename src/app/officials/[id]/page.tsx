            ...
            <div className="flex items-start gap-3">
              ...
              <div>
                <p className="text-sm font-semibold text-blue-800">
                  Federal Officials &mdash; Groups Only (Public Beta)
                </p>
                <p className="mt-1 text-sm text-blue-700">
                  While AskThem is in public beta, only verified Groups &mdash; advocacy organizations, think tanks,
                  and nonprofits &mdash; can ask questions to federal officials. You can{" "}
                  <Link href="/groups" className="font-medium text-blue-800 underline hover:text-blue-900">
                    browse existing Groups
                  </Link>{" "}
                  or{" "}
                  <Link href="/groups/apply" className="font-medium text-blue-800 underline hover:text-blue-900">
                    apply to start one
                  </Link>.
                </p>
              </div>
