...
export default async function Home() {
  ...
  return (
    <div className="min-h-screen bg-gray-50" style={{ backgroundImage: "url('/footer_illustration.jpg')", backgroundPosition: "bottom center", backgroundRepeat: "no-repeat", backgroundSize: "100% auto" }}>
      {/* Hero */}
