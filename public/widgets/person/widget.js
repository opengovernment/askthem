(function() {
  ...
  if (!window.AskThemPersonWidget) { window.AskThemPersonWidget = {}; };
  var AskThemPersonWidget = window.AskThemPersonWidget;

  // To keep track of which embeds we have already processed
  if (!AskThemPersonWidget.foundEmbeds) AskThemPersonWidget.foundEmbeds = [];
  var foundEmbeds = AskThemPersonWidget.foundEmbeds;
  ...
  function appFromConcoction(tagId) {
    ...
    jQuery.get('http://www.askthem.io/widgets/person/app-concoction.txt', function(data) {
      appConcoction = data;
      ...
      (function poll() {
        setTimeout( function() {
          if (AskThemPersonWidget.jsNecessaryToComplete === 0) {
            eval(appCode);
          } else {
            poll();
          }
  ...
  function main() {
    jQuery(document).ready(function($) {
      ...
      var cssUrls = ['http://www.askthem.io/widgets/person/assets/vendor-ba26407e909fb4a64f1f0a2ade32443c.css',
                     'http://www.askthem.io/widgets/person/assets/person-widget-5026464cc3f47e1a262bc265daae12e0.css'];

      addCssLinksIfNecessary(cssUrls);

      var jsUrls = ['http://www.askthem.io/widgets/person/assets/vendor-ade829476ace9e79a697b45904164efd.js'];

      // track if all our scripts have loaded globally
      // we increment and decrement within addJSIfNecessary
      if (!AskThemPersonWidget.jsNecessaryToComplete) AskThemPersonWidget.jsNecessaryToComplete = 0;
      ...
      jQuery('.at-widget-loader').each(function(i) {
        if (foundEmbeds.indexOf(this) < 0) {
          ...
          var personPoliticalPositionTitle = "";
          if(paramsDiv) {
          ...
          var options = {
            ...
            person: {
              ...
              state: personState,
              political_position_title: personPoliticalPositionTitle,
              most_recent_district: personMostRecentDistrict
            }
          };
