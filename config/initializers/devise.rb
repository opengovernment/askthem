...
Devise.setup do |config|
  ...
  config.mailer_sender = ENV["NOTIFICATION_SENDER_EMAIL"]
  ...
  # config.pepper = "32c6b4eaa5f3b84f4bb440752bd167d42fc5be3ea9205fbc5e1cef0cdbb17d18ae854fa2bf17cb83b7c24c976409892abdba11ff0a2883747564174d2c65e9cd"
  ...
  # @see https://github.com/mkdynamic/omniauth-facebook#configuring
  config.omniauth :facebook, '124751554385930', ENV['FACEBOOK_APP_SECRET'], info_fields: "email,first_name,last_name,location,middle_name,username,website,verified,link"
...
Warden::Manager.after_set_user({}, :unshift) do |record, warden, options|
