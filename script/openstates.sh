#!/bin/bash
# @note It is not recommended to use the MongoDB dump in production as it is not
...
# @note Can add --noIndexRestore and use billy-util mongo-index --purge command instead.
